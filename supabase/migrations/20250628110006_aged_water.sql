...
1. Security
   ...
   - Fix column references in bookings table policies
...
-- Add a duplicate policy with a different name for backward compatibility
...
-- Add a basic read policy for authenticated users
CREATE POLICY "Allow read for authenticated" ON public.bookings
