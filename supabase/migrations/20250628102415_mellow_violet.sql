/*
  # Fix RLS Policies for Secure Access
  ...
  2. Policy Changes
    - Create or replace policies for all tables
...
DROP POLICY IF EXISTS "Bookings by branch" ON public.bookings;
...
DROP POLICY IF EXISTS "Customers by branch" ON public.customers;
...
DROP POLICY IF EXISTS "Articles by branch" ON public.articles;
...
DROP POLICY IF EXISTS "Vehicles by branch" ON public.vehicles;
...
DROP POLICY IF EXISTS "Loading sessions by branch" ON public.loading_sessions;
...
DROP POLICY IF EXISTS "Unloading sessions by branch" ON public.unloading_sessions;
...
DROP POLICY IF EXISTS "POD records by branch" ON public.pod_records;
...
DROP POLICY IF EXISTS "Expenses by branch" ON public.expenses;
...
DROP POLICY IF EXISTS "Vendors by branch" ON public.vendors;
